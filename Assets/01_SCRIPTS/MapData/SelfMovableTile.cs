...
public class SelfMovableTile : RotatableTile
{
    ...
    {
        this.key = key;
        SelfMovable prefab = MovableDictionary.GetSelfMovable(key).GetComponent<SelfMovable>();
